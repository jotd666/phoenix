...
0091: 21 A0 43        LD      HL,unknown_43A0            ; Value from ...
...
;
CheckInputBits:
00BB: 21 A0 43        LD      HL,unknown_43A0            ; Get current ...
...
0380: 21 3F 43        LD      HL,unknown_433F            
...
04CC: 00              NOP                         
04CD: 21 A3 43        LD      HL,unknown_43A3            
04D0: 7E              LD      A,(HL)              
04D1: A7              AND     A                   
04D2: 2E 83           LD      L,$83               
...
276C: 06 06           LD      B,$06               
276E: 3A A3 43        LD      A,(unknown_43A3)           
2771: A7              AND     A                   
...
2789: D0              RET     NC                  
278A: 3A A3 43        LD      A,(unknown_43A3)           
278D: C6 90           ADD     $90                 
278F: 6F              LD      L,A                 
2790: 34              INC     (HL)                
...
30E7: 21 9A 43        LD      HL,unknown_439A            
30EA: 7E              LD      A,(HL)              
30EB: FE 10           CP      $10                 
...
3908: 71              LD      (HL),C              
3909: 2C              INC     L                   
390A: 3A E6 43        LD      A,(unknown_43E6)           
390D: 77              LD      (HL),A              
390E: 2C              INC     L                   
...
399B: 2E E2           LD      L,$E2               
399D: 11 E6 43        LD      DE,unknown_43E6            
39A0: 06 02           LD      B,$02               
...
3A80: 77              LD      (HL),A              
3A81: C9              RET                         
3A82: 21 9A 43        LD      HL,unknown_439A            
3A85: 7E              LD      A,(HL)              
3A86: FE 03           CP      $03                 
3A88: D8              RET     C                   
3A89: 2E 8D           LD      L,$8D               
...
3B00: C9              RET                         
3B01: 8E              ADC     A,(HL)              
3B02: 21 9A 43        LD      HL,unknown_439A            
3B05: 7E              LD      A,(HL)              
3B06: FE 02           CP      $02                 
3B08: D0              RET     NC                  
3B09: 2C              INC     L                   
